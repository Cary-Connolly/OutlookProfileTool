...
$Script:MigrateMsg = "Your new M365 mailbox is ready to be set up.`r`n`r` This process will take a few minutes. `r`n`r`Click OK to begin. `r`n`r`Votre nouveau service de courriel M365 est prêt à être configuré.`r`n`r` Ce processus prendra quelques minutes. `r`n`r`Cliquer sur OK pour commencer."

$Script:MigrateMsgOutlookOpened = "Your new M365 mailbox is ready to be set up.`r`n`r` This process will take a few minutes. `r`n`r`Please close all Outlook windows and click OK to begin. `r`n`r`Votre nouveau service de courriel M365 est prêt à être configuré.`r`n`r` Ce processus prendra quelques minutes. `r`n`r`Veuillez fermer toutes les fenêtres Outlook et cliquer sur OK pour commencer."
...
$XMLfile = "$PSScriptRoot\config.xml"
...
#endregion Functions
#region Main
Add-Type -Path 'C:\Windows\Microsoft.NET\Framework\v2.0.50727\Microsoft.VisualBasic.dll'
Add-Type -Path "$PSScriptRoot\System.Management.Automation.dll"
